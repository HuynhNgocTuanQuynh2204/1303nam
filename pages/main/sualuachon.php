    ...
    <div class="text-center">
        <section class="container my-2 bg-secondary w-50 text-light p-2">
            ...
            <form class="row g-3 p-3" method="POST"
                action="index.php?quanly=xulythemluachon&id=<?php echo $row['id_luachon'] ?>"
                enctype="multipart/form-data">
                <div class="col-md-12">
                    <label for="validationDefault01" class="form-label">Selection</label>
                    <input type="text" class="form-control" id="validationDefault01" name="selection"
                        placeholder="Selection" value="<?php echo $row['selection'] ?>">
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-6">
                    ...
                    // Kết hợp id_tieuchi và criteria thành một giá trị duy nhất cho tùy chọn
                    $combined_value = $row_tieuchi['id_tieuchi'] . "||" . $row_tieuchi['criteria'];
                    ?>
                        <option value="<?php echo $combined_value; ?>"
                            <?php if ($row['id_tieuchi'] == $row_tieuchi['id_tieuchi']) echo 'selected'; ?>>
